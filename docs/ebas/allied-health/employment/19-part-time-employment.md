...
- **(e)** Where the request is refused by the Employer:
    ...
    - **(iii)** where a dispute arises in relation to the response by the Employer it will be dealt with in accordance with Clause 14 (Dispute Resolution Procedure).
