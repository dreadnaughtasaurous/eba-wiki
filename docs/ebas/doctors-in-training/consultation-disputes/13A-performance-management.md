...
- **(b)** Where an Employer has concerns about a performance issue that may constitute misconduct, they will be dealt with in accordance with clause 13B (Discipline). Where this occurs, the performance management process in subclauses 13A.4(c), (d) and (e) will still apply where appropriate.
...
- **(d)** Where, having considered the Employee’s response, the Employer reasonably believes, based on the Employee’s performance, that a performance management plan is appropriate, the Employer will:
  - **(i)** provide the performance management plan to the Employee in writing following the consultation referred to at subclause 13A.4(c)(iv), identifying which aspects of the Employee’s performance are unsatisfactory and the required level of performance which must be reasonable; and
